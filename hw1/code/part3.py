...
class CNN(nn.Module):
    ...
    def forward(self, x):
        #(1,28,28)
        x = F.relu(self.conv1(x))#(10,(28-5+1)=24,24)
        x1 = self.max_pool(x)#(10,12,12)
        x2 = F.relu(self.conv2(x1))#(50,12-5+1=8,8)
        x3 = self.max_pool(x2)#(50,4,4)
...
class NNModel:
    ...
    def view_batch(self):
        ...
        img1 = images.view(64,28,28)
        #print(img1.shape)
        #torch.Size([64, 28, 28])
        img2 =img1.view(8,8,28,28)
        #print(img2.shape)
        img3 = img2.permute(0,2,1,3)
        #print(img3.shape)
        img4 = img3.reshape([8*28,8*28])
